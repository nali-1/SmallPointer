...
void smpt_rd_vk_cmdMset()
{
	...
	for (uint8_t l_0 = 0; l_0 < smpt_rd_vk_swcUimage; ++l_0)
	{
		...
		SMPT_RD_VKFmMAKE(SMPT_RD_VKQuGP, Pvkfence + l_0)

		for (uint8_t l_1 = 0; l_1 < 2; ++l_1)
		{
			SMPT_RD_VK_SMPmMAKE(SMPT_RD_VKQuGP, Pvksemaphore + l_0 * smpt_rd_vk_swcUimage + l_1)
		}
	}
...
void smpt_rd_vk_cmdMfree()
{
	...
	for (uint8_t l_0 = 0; l_0 < smpt_rd_vk_swcUimage; ++l_0)
	{
		vkDestroyFence(Vvkdevice, Pvkfence[l_0], VK_NULL_HANDLE);

		for (uint8_t l_1 = 0; l_1 < 2; ++l_1)
		{
			vkDestroySemaphore(Vvkdevice, Pvksemaphore[l_0 * smpt_rd_vk_swcUimage + l_1], VK_NULL_HANDLE);
		}
	}
