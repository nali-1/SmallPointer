...
//	#define SMPTRuI 1
	...
	#define SMPTRxMK \
		X(POMI_IDLE, SMPTReM_POMI, 16, 18) \
		X(POMI_WALK_START, SMPTReM_POMI, 0, 6) \
		X(POMI_WALK_MID, SMPTReM_POMI, 6, 11) \
		X(POMI_WALK_END, SMPTReM_POMI, 11, 14) \
		X(POMI_JUMP, SMPTReM_POMI, 14, 16) \
