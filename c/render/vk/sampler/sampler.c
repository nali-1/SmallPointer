void smpt_rd_vk_spMmake(uint8_t Udevice, uint8_t Umipmap, uint8_t Uline, VkSampler* Pvksampler)
{
	VkSamplerCreateInfo vksamplercreateinfo =
	{
		...
		.anisotropyEnable = smpt_rd_vkqPinfo[Udevice].Fmax_sampler_anisotropy == 0 ? VK_FALSE : VK_TRUE,
		.maxAnisotropy = smpt_rd_vkqPinfo[Udevice].Fmax_sampler_anisotropy,
		.mipLodBias = 0,
		.minLod = 0,
		.maxLod = Umipmap,
		.flags = 0,
